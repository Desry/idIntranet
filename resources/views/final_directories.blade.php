    ...
    <ul class="collapsible popout" data-collapsible="popout">
        <li>
            ...
            <div class="collapsible-body">
                ...
                <div class="row valign-wrapper">
                    ...
                    <div class="col s8 center-align">
                        <span class="black-text"><strong>Miroslaw Andziak</strong> | Chief Executive Officer</span><br>
                    </div>
                </div>
            </div>
            <div class="collapsible-body">
            ...
            <div class="collapsible-body">
                ...
                <div class="row valign-wrapper">
                    <div class="col s2">
                        <img src="images/directories/lukasz.jpg" alt="" class="circle responsive-img">
                    </div>
                    <div class="col s8 center-align">
                        <span class="black-text"><strong>Lukasz Wilke </strong>| Chief Technologist</span>
                    </div>
                </div>
            </div>
            <div class="collapsible-body">
        ...
        <li>
            ...
            <div class="collapsible-body">
                ...
                <div class="row valign-wrapper">
                    <div class="col s2">
                        <img src="images/directories/eiman.jpg" alt="" class="circle responsive-img">
                    </div>
                    <div class="col s8 center-align">
                        <span class="black-text"><strong>John Eiman Mission </strong>| Product Solutions Engineer</span>
                    </div>
                </div>
            </div>
            <div class="collapsible-body">
                ...
                <div class="row valign-wrapper">
                    <div class="col s2">
                        <img src="images/directories/desry.jpg" alt="" class="circle responsive-img">
                    </div>
                    <div class="col s8 center-align">
                        <span class="black-text"><strong>Desry Hernalin </strong>| Product Solutions Engineer</span>
                    </div>
                </div>
            </div>
        ...
        <li>
            ...
            <div class="collapsible-body">
                ...
                <div class="row valign-wrapper">
                    ...
                    <div class="col s8">
                        <span class="black-text"><strong>Jeremie Diaz</strong> | Technology Content Writer</span>
                    </div>
                </div>
            </div>
        </li>
